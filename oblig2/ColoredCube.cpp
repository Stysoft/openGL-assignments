...
void ColoredCube::init(float size) {
  ...
  ColoredCubeVertex vertices[] = {
    ColoredCubeVertex(-0.5,  0.5,  0.5, 0.0, 0.0, 0.0),
    ColoredCubeVertex( 0.5,  0.5,  0.5, 0.0, 0.0, 1.0),
    ColoredCubeVertex( 0.5, -0.5,  0.5, 0.0, 1.0, 0.0),
    ColoredCubeVertex(-0.5, -0.5,  0.5, 0.0, 1.0, 1.0),
    ColoredCubeVertex(-0.5,  0.5, -0.5, 1.0, 0.0, 0.0),
    ColoredCubeVertex( 0.5,  0.5, -0.5, 1.0, 0.0, 1.0),
    ColoredCubeVertex( 0.5, -0.5, -0.5, 1.0, 1.0, 0.0),
    ColoredCubeVertex(-0.5, -0.5, -0.5, 1.0, 1.0, 1.0),
  };
